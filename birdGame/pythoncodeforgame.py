...
bird_up = pygame.image.load("bird.png")
bird_down = pygame.image.load("bird1.png")
bird_mid = pygame.image.load("bird2.png")
...
game_over = False
over_img = pygame.image.load("startimage.png").convert_alpha ()
